...
function EnableGUI(enable)
    if enable then TriggerServerEvent('PX_mdt:opendashboard') end
    SetNuiFocus(enable, enable)
    SendNUIMessage({ type = "show", enable = enable, job = ESX.GetPlayerData().job.name })

    isOpen = enable
    TriggerEvent('PX_mdt:animation')
end
...
AddEventHandler('PX_mdt:animation', function()
...
RegisterNetEvent('PX_mdt:dashboardbulletin')
AddEventHandler('PX_mdt:dashboardbulletin', function(sentData)
    SendNUIMessage({ type = "bulletin", data = sentData })
end)

RegisterNetEvent('PX_mdt:dashboardWarrants')
AddEventHandler('PX_mdt:dashboardWarrants', function(sentData)
    SendNUIMessage({ type = "warrants", data = sentData })
end)

RegisterNetEvent('PX_mdt:dashboardReports')
AddEventHandler('PX_mdt:dashboardReports', function(sentData)
    SendNUIMessage({ type = "reports", data = sentData })
end)

RegisterNetEvent('PX_mdt:dashboardCalls')
AddEventHandler('PX_mdt:dashboardCalls', function(sentData)
    SendNUIMessage({ type = "calls", data = sentData })
end)

RegisterNUICallback("deleteBulletin", function(data, cb)
    local id = data.id
    TriggerServerEvent('PX_mdt:deleteBulletin', id)
    cb(true)
end)
...
RegisterNUICallback("newBulletin", function(data, cb)
    ...
    TriggerServerEvent('PX_mdt:newBulletin', title, info, time, data.id)
    cb(true)
end)

RegisterNetEvent('PX_mdt:newBulletin')
AddEventHandler('PX_mdt:newBulletin', function(ignoreId, sentData, job)
...
RegisterNetEvent('PX_mdt:deleteBulletin')
AddEventHandler('PX_mdt:deleteBulletin', function(ignoreId, sentData, job)
    if ignoreId == GetPlayerServerId(PlayerId()) then return end;
    if job == 'police' and ESX.GetPlayerData().job.name == "police" then
...
RegisterNetEvent('PX_mdt:open')
AddEventHandler('PX_mdt:open', function(jobLabel, name)
    open = true
    EnableGUI(open)
    ...
    SendNUIMessage({ type = "data", name = "Welcome, " ..jobLabel..' '.. name, location = playerStreetsLocation, fullname = name })
end)
...
RegisterNUICallback("searchProfiles", function(data, cb)
    ...
    TriggerServerEvent('PX_mdt:searchProfile', name)
    cb(true)
end)

RegisterNetEvent('PX_mdt:exitMDT')
AddEventHandler('PX_mdt:exitMDT', function()
    open = false
    EnableGUI(open)
end)
...
RegisterNetEvent('PX_mdt:searchProfile')
AddEventHandler('PX_mdt:searchProfile', function(sentData, isLimited)
    SendNUIMessage({ type = "profiles", data = sentData, isLimited = isLimited })
end)

RegisterNUICallback("refreshProfiles", function(data, cb)
    TriggerServerEvent("PX_mdt:refreshProfiles")
    cb(true)
end)
...
RegisterNUICallback("saveProfile", function(data, cb)
    ...
    TriggerServerEvent("PX_mdt:saveProfile", profilepic, information, cid, fName, sName)
    cb(true)
end)

RegisterNUICallback("getProfileData", function(data, cb)
    local id = data.id
    TriggerServerEvent('PX_mdt:getProfileData', id)
    cb(true)
end)

RegisterNUICallback("newTag", function(data, cb)
    if data.id ~= "" and data.tag ~= "" then
        TriggerServerEvent('PX_mdt:newTag', data.id, data.tag)
    end
    cb(true)
end)
...
RegisterNUICallback("removeProfileTag", function(data, cb)
    ...
    TriggerServerEvent('PX_mdt:removeProfileTag', cid, tagtext)
    cb(removeProfileTag)
end)

RegisterNetEvent('PX_mdt:getProfileData')
AddEventHandler('PX_mdt:getProfileData', function(sentData)
...
RegisterNUICallback("updateLicence", function(data, cb)
    ...
    local cid = data.cid
    TriggerServerEvent('PX_mdt:updateLicense', cid, type, status)
    cb(true)
end)
...
RegisterNUICallback("addGalleryImg", function(data, cb)
    local cid = data.cid
    local url = data.URL
    TriggerServerEvent('PX_mdt:addGalleryImg', cid, url)
    cb(true)
end)
...
RegisterNUICallback("removeGalleryImg", function(data, cb)
    local cid = data.cid
    local url = data.URL
    TriggerServerEvent('PX_mdt:removeGalleryImg', cid, url)
    cb(true)
end)

RegisterNUICallback("searchIncidents", function(data, cb)
    local incident = data.incident
    TriggerServerEvent('PX_mdt:searchIncidents', incident)
    cb(true)
end)


RegisterNetEvent('PX_mdt:getIncidents')
AddEventHandler('PX_mdt:getIncidents', function(sentData)
    SendNUIMessage({ type = "incidents", data = sentData })
end)

RegisterNUICallback("getIncidentData", function(data, cb)
    local id = data.id
    TriggerServerEvent('PX_mdt:getIncidentData', id)
    cb(true)
end)

RegisterNetEvent('PX_mdt:getIncidentData')
AddEventHandler('PX_mdt:getIncidentData', function(sentData, sentConvictions)
...
RegisterNUICallback("incidentSearchPerson", function(data, cb)
    local name = data.name
    TriggerServerEvent('PX_mdt:incidentSearchPerson', name)
    cb(true)
end)

RegisterNetEvent('PX_mdt:incidentSearchPerson')
AddEventHandler('PX_mdt:incidentSearchPerson', function(sentData)
...
RegisterNUICallback("searchBolos", function(data, cb)
    ...
    TriggerServerEvent('PX_mdt:searchBolos', searchVal)
    cb(true)
end)

RegisterNetEvent('PX_mdt:getBolos')
AddEventHandler('PX_mdt:getBolos', function(sentData)
    SendNUIMessage({ type = "bolos", data = sentData })
end)

RegisterNUICallback("getAllBolos", function(data, cb)
    TriggerServerEvent('PX_mdt:getAllBolos')
    cb(true)
end)

RegisterNetEvent('PX_mdt:getAllIncidents')
AddEventHandler('PX_mdt:getAllIncidents', function(sentData)
    SendNUIMessage({ type = "incidents", data = sentData })
end)

RegisterNUICallback("getAllIncidents", function(data, cb)
    TriggerServerEvent('PX_mdt:getAllIncidents')
    cb(true)
end)

RegisterNetEvent('PX_mdt:getAllBolos')
AddEventHandler('PX_mdt:getAllBolos', function(sentData)
    SendNUIMessage({ type = "bolos", data = sentData })
end)

RegisterNUICallback("getBoloData", function(data, cb)
    local id = data.id
    TriggerServerEvent('PX_mdt:getBoloData', id)
    cb(true)
end)

RegisterNetEvent('PX_mdt:getBoloData')
AddEventHandler('PX_mdt:getBoloData', function(sentData)
...
RegisterNUICallback("newBolo", function(data, cb)
    ...
    local time = data.time
    TriggerServerEvent('PX_mdt:newBolo', data)
    cb(true)
end)

RegisterNetEvent('PX_mdt:boloComplete')
AddEventHandler('PX_mdt:boloComplete', function(sentData)
    SendNUIMessage({ type = "boloComplete", data = sentData })
end)

RegisterNUICallback("deleteIncident", function(data, cb)
    local id = data.id
    TriggerServerEvent('PX_mdt:deleteIncident', id)
    cb(true)
end)

RegisterNUICallback("deleteBolo", function(data, cb)
    local id = data.id
    TriggerServerEvent('PX_mdt:deleteBolo', id)
    cb(true)
end)

RegisterNUICallback("deleteICU", function(data, cb)
    local id = data.id
    TriggerServerEvent('PX_mdt:deleteICU', id)
    cb(true)
end)
...
RegisterNUICallback("getAllReports", function(data, cb)
    TriggerServerEvent('PX_mdt:getAllReports')
    cb(true)
end)

RegisterNetEvent('PX_mdt:getAllReports')
AddEventHandler('PX_mdt:getAllReports', function(sentData)
    SendNUIMessage({ type = "reports", data = sentData })
end)

RegisterNUICallback("getReportData", function(data, cb)
    local id = data.id
    TriggerServerEvent('PX_mdt:getReportData', id)
    cb(true)
end)

RegisterNetEvent('PX_mdt:getReportData')
AddEventHandler('PX_mdt:getReportData', function(sentData)
    SendNUIMessage({ type = "reportData", data = sentData })
end)

RegisterNUICallback("searchReports", function(data, cb)
    local name = data.name
    TriggerServerEvent('PX_mdt:searchReports', name)
    cb(true)
end)

RegisterNUICallback("newReport", function(data, cb)
    TriggerServerEvent('PX_mdt:newReport', data)
    cb(true)
end)

RegisterNetEvent('PX_mdt:reportComplete')
AddEventHandler('PX_mdt:reportComplete', function(sentData)
...
RegisterNUICallback("searchVehicles", function(data, cb)
    local name = data.name
    TriggerServerEvent('PX_mdt:searchVehicles', name)
    cb(true)
end)
...
RegisterNetEvent('PX_mdt:searchVehicles')
AddEventHandler('PX_mdt:searchVehicles', function(sentData)
    for i=1, #sentData do
        ...
        sentData[i]['model'] = GetDisplayNameFromVehicleModel(vehicle['model'])
    end
...
RegisterNUICallback("getVehicleData", function(data, cb)
    local plate = data.plate
    TriggerServerEvent('PX_mdt:getVehicleData', plate)
    cb(true)
end)
...
RegisterNetEvent('PX_mdt:getVehicleData')
AddEventHandler('PX_mdt:getVehicleData', function(sentData)
    if sentData and sentData[1] then
        ...
        vehicle['model'] = GetDisplayNameFromVehicleModel(vehData['model'])
...
RegisterNUICallback("saveVehicleInfo", function(data, cb)
    ...
    TriggerServerEvent('PX_mdt:saveVehicleInfo', dbid, plate, imageurl, notes)
    cb(true)
end)

RegisterNetEvent('PX_mdt:updateVehicleDbId')
AddEventHandler('PX_mdt:updateVehicleDbId', function(sentData)
...
RegisterNUICallback("knownInformation", function(data, cb)
    ...
    local status = data.status
    local plate = data.plate
    TriggerServerEvent('PX_mdt:knownInformation', dbid, type, status, plate)
    cb(true)
end)

RegisterNUICallback("getAllLogs", function(data, cb)
    TriggerServerEvent('PX_mdt:getAllLogs')
    cb(true)
end)

RegisterNetEvent('PX_mdt:getAllLogs')
AddEventHandler('PX_mdt:getAllLogs', function(sentData)
    SendNUIMessage({ type = "getAllLogs", data = sentData })
end)

RegisterNUICallback("getPenalCode", function(data, cb)
    TriggerServerEvent('PX_mdt:getPenalCode')
    cb(true)
end)

RegisterNetEvent('PX_mdt:getPenalCode')
AddEventHandler('PX_mdt:getPenalCode', function(titles, penalcode)
    SendNUIMessage({ type = "getPenalCode", titles = titles, penalcode = penalcode })
end)

RegisterNetEvent('PX_mdt:getActiveUnits')
AddEventHandler('PX_mdt:getActiveUnits', function(lspd, ems, sheriff)
    SendNUIMessage({ type = "getActiveUnits", lspd = lspd, ems = ems, sheriff = sheriff})
end)

RegisterNUICallback("toggleDuty", function(data, cb)
    TriggerServerEvent('PX_mdt:toggleDuty', data.cid, data.status)
    cb(true)
end)

RegisterNUICallback("setCallsign", function(data, cb)
    TriggerServerEvent('PX_mdt:setCallsign', data.cid, data.newcallsign)
    cb(true)
end)

RegisterNetEvent('PX_mdt:updateCallsign')
AddEventHandler('PX_mdt:updateCallsign', function(callsign)
    callSign = tostring(callsign)
end)

RegisterNUICallback("saveIncident", function(data, cb)
    TriggerServerEvent('PX_mdt:saveIncident', data)
    cb(true)
end)

RegisterNetEvent('PX_mdt:updateIncidentDbId')
AddEventHandler('PX_mdt:updateIncidentDbId', function(sentData)
    SendNUIMessage({ type = "updateIncidentDbId", data = tonumber(sentData) })
end)

RegisterNUICallback("removeIncidentCriminal", function(data, cb)
    TriggerServerEvent('PX_mdt:removeIncidentCriminal', data.cid, data.incidentId)
    cb(true)
end)
...
RegisterNUICallback("callDetach", function(data, cb)
    TriggerServerEvent('PX_mdt:callDetach', data.callid)
    cb(true)
end)

RegisterNetEvent('PX_mdt:callDetach')
AddEventHandler('PX_mdt:callDetach', function(callid, sentData)
...
RegisterNUICallback("callAttach", function(data, cb)
    TriggerServerEvent('PX_mdt:callAttach', data.callid)
    cb(true)
end)

RegisterNetEvent('PX_mdt:callAttach')
AddEventHandler('PX_mdt:callAttach', function(callid, sentData)
    local job = ESX.GetPlayerData().job
...
RegisterNUICallback("attachedUnits", function(data, cb)
    TriggerServerEvent('PX_mdt:attachedUnits', data.callid)
    cb(true)
end)

RegisterNetEvent('PX_mdt:attachedUnits')
AddEventHandler('PX_mdt:attachedUnits', function(sentData, callid)
    SendNUIMessage({ type = "attachedUnits", data = sentData, callid = callid })
end)

RegisterNUICallback("callDispatchDetach", function(data, cb)
    TriggerServerEvent('PX_mdt:callDispatchDetach', data.callid, data.cid)
    cb(true)
end)

RegisterNUICallback("setDispatchWaypoint", function(data, cb)
    TriggerServerEvent('PX_mdt:setDispatchWaypoint', data.callid, data.cid)
    cb(true)
end)

RegisterNUICallback("callDragAttach", function(data, cb)
    TriggerServerEvent('PX_mdt:callDragAttach', data.callid, data.cid)
    cb(true)
end)

RegisterNUICallback("setWaypointU", function(data, cb)
    TriggerServerEvent('PX_mdt:setWaypoint:unit', data.cid)
    cb(true)
end)

RegisterNetEvent('PX_mdt:setWaypoint:unit')
AddEventHandler('PX_mdt:setWaypoint:unit', function(sentData) 
...
RegisterNUICallback("dispatchMessage", function(data, cb)
    TriggerServerEvent('PX_mdt:sendMessage', data.message, data.time)
    cb(true)
end)
...
RegisterNetEvent('PX_mdt:dashboardMessages')
AddEventHandler('PX_mdt:dashboardMessages', function(sentData)
    SendNUIMessage({ type = "dispatchmessages", data = sentData })
end)

RegisterNUICallback("refreshDispatchMsgs", function(data, cb)
    TriggerServerEvent('PX_mdt:refreshDispatchMsgs')
    cb(true)
end)
...
RegisterNUICallback("dispatchNotif", function(data, cb)
    ...
    if mentioned then
        TriggerEvent('PX_phone:sendNotification', {img = info['profilepic'], title = "Dispatch (Mention)", content = info['message'], time = 7500, customPic = true })
        PlaySoundFrontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", false)
        PlaySoundFrontend(-1, "Event_Start_Text", "GTAO_FM_Events_Soundset", 0)
    else
        TriggerEvent('PX_phone:sendNotification', {img = info['profilepic'], title = "Dispatch ("..info['name']..")", content = info['message'], time = 5000, customPic = true })
    end
    cb(true)
end)

RegisterNUICallback("getCallResponses", function(data, cb)
    TriggerServerEvent('PX_mdt:getCallResponses', data.callid)
    cb(true)
end)

RegisterNetEvent('PX_mdt:getCallResponses')
AddEventHandler('PX_mdt:getCallResponses', function(sentData, sentCallId)
...
RegisterNUICallback("sendCallResponse", function(data, cb)
    TriggerServerEvent('PX_mdt:sendCallResponse', data.message, data.time, data.callid)
    cb(true)
end)

RegisterNetEvent('PX_mdt:sendCallResponse')
