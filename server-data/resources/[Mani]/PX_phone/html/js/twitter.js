...
$(document).on('click', '.twitter-header-tab', function (e) {
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('http://PX_phone/ClearMentions');
        }
        ...
        if (PressedTwitterTab == "twitter-self") {
            $.post('http://PX_phone/GetSelfTweets', JSON.stringify({}), function (selfdata) {
...
$(document).on('click', '.tweet-delete', function (e) {
    ...
    console.log(id)
    $.post('http://PX_phone/DeleteTweet', JSON.stringify({
        id: id,
    }));

    $.post('http://PX_phone/GetSelfTweets', JSON.stringify({}), function (tweets) {
...
$(document).on('click', '#send-tweet', function (e) {
    ...
    if (TweetMessage != "" || TweetUrl != "") {
        ...
        $.post('http://PX_phone/PostNewTweet', JSON.stringify({
...
$(document).on('click', '#send-photo', function (e) {
    ...
    $.post('http://PX_phone/PostNewImage', JSON.stringify({}),
        function (url) {
...
$(document).on('click', '.hashtag-tag-text', function (e) {
    ...
    if (!HashtagOpen) {
        ...
        $.post('http://PX_phone/GetHashtagMessages', JSON.stringify({
            hashtag: Hashtag
