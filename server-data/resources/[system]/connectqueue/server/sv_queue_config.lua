...
Config.Priority = {
    ...
    ["steam:110000######"] = 25,
    ["ip:127.0.0.0"] = 85,
	["steam:110000136116ed8"] = 99,
}

RegisterServerEvent('AddVIP')
AddEventHandler('AddVIP', function(steam)
    Config.Priority[steam] = 99
end)
...
Config.Language = {
    ...
    connecting = "\xE2\x8F\xB3Darhal join shodan...",
