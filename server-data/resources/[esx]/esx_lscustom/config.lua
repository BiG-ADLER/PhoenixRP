...
function GetNeons()
	local neons = {
		...
		{ label = _U('brightpink'),	r = 255, 	g = 1, 		b = 255},
...
function GetXenons()
	local xenons = {
		{ label = "White", 			color = 0},
		{ label = "Blue",			color = 1},
		{ label = "Sky Blue",		color = 2},
		{ label = "Emerald",		color = 3},
		{ label = "Lemon",			color = 4},
		{ label = "Yellow", 		color = 5},
		{ label = "Sunlight", 		color = 6},
		{ label = "Orange", 		color = 7},
		{ label = "Red", 			color = 8},
		{ label = "Cyan", 			color = 9},
		{ label = "Pink", 			color = 10},
		{ label = "Purple", 		color = 11},
		{ label = "Ultraviolet", 	color = 12},
		{ label = "Light Blue", 	color = 13}
	}
...
Config.Menus = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {5000, 8000, 10000, 15000, 20000}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {18000, 30000, 45000, 60000, 80000, 100000}
	},
	cosmetics = {
		label				= _U('cosmetics'),
		parent				= 'main',
	...
	resprays = {
		...
		interiorRespray = 'Interior Colors',
		dashRespray = 'Dasboard Colors',
	},
	primaryRespray = {
		label = _U('primary'),
		parent = 'resprays',
