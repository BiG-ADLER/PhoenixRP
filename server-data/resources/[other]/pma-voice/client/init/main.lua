...
SetAudioSubmixEffectParamFloat(radioEffectId, 1, GetHashKey('rm_mix'), 0.16)
SetAudioSubmixEffectParamFloat(radioEffectId, 1, GetHashKey('freq_low'), 389.0)
SetAudioSubmixEffectParamFloat(radioEffectId, 1, GetHashKey('freq_hi'), 3248.0)
...
function toggleVoice(plySource, enabled, moduleType)
	if enabled then
		...
		SetTimeout(250, function()
			if disableSubmixReset[plySource] then
