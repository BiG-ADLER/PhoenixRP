...
if not Config.CustomMenuEnabled then
  ...
  mainMenu = NativeUI.CreateMenu(Config.MenuText, "", menuPosition["x"], menuPosition["y"], Menuthing, Menuthing)
end
...
function AddWalkMenu(menu)
    ...
    submenu.OnItemSelect = function(sender, item, index)
      if stress <= 20 then
        ...
        TriggerEvent("esx:showNotification", "Shoma Stress Darid!")
      end
    end
end
...
function AddInfoMenu(menu)
    ...
    u170 = NativeUI.CreateItem("1.7.0", "Added Stress System!")
    ...
    u151 = NativeUI.CreateItem("1.5.1", "Update Walking Style with Stress by Mani :)")
